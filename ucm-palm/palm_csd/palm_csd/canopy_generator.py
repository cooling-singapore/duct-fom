                ...
                if valid_pixels[j, i]:
                    ...
                    lad_loc, bad_loc, x_loc, y_loc, z_loc, low_lai_count, mod_count, status = \
                        process_single_tree(i, j, dx, dz,
                                            tree_type[j, i], ma.masked, tree_height[j, i],
...
def process_single_tree(i, j, dx, dz,
    ...
    default_trees.append(Tree("Yellow flame tree",    1.0, 0.6,  25.0, 20.0, 3.0, 3.0, 0.6, 0.025, 0.40))
    default_trees.append(Tree("Derum Selunchor tree", 1.0, 0.5,  10.0, 10.0, 3.0, 3.0, 0.6, 0.025, 0.30))
    default_trees.append(Tree("Handkerchief tree",    3.0, 1.0,  9.0, 10.0, 4.0, 4.0, 0.6, 0.025, 0.20))
